  ...
  return (
    ...
    <div className={styles.mainDiv}>
      <div className={styles.leftDiv}>
        ...
        <ul className={styles.list}>
          {listItems.map((item, index) => (
            <li key={index}>
              <img src="https://www.edmylett.com/_next/static/media/check.be2ace8b.svg" alt="Check Icon" />
              {item}
            </li>
          ))}
        </ul>
      ...
      <div className={styles.rightDiv}>
        <img src="	https://www.edmylett.com/img/books/ThePowerOfOneMore.png" alt="Your Image Alt" className={styles.image} />
