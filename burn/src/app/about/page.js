        ...
        <div className={styles.mainHero}>
          <div className={styles.hero}>
            ...
            <div className={`${styles.heroMain} ${styles2.heroMain}`}>
              ...
              <h1 className={styles2.heroText}>
                {" "}
                <span className="colorPrimary">Edward Burns</span> is a global
                keynote speaker,{" "}
                <span className="colorPrimary"> 2x bestselling author</span>,
                the host of the critically acclaimed and top rated podcast,{" "}
                <span className="colorPrimary">“The Edward Burns Show.”</span>
              </h1>
